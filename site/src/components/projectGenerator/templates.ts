...
/** Matches flixelgdx-lwjgl3 0.3.0 POM (com.badlogicgames.gdx:gdx-backend-lwjgl3). */
...
function lwjgl3BuildGradle(o: GeneratorOptions): string {
  ...
  return [
    ...
    `  // StartupHelper (com.badlogic.gdx.backends.lwjgl3) ships in this artifact; listing it keeps the dependency visible.`,
...
const IDE_TIPS: Record<IDE, IdeTips | null> = {
  idea: {
    ...
    steps: [
      ...
      '3. Run the game via the Gradle tool window (`:lwjgl3:run` or `lwjgl3Run` for desktop, `:teavm:run` for web),',
