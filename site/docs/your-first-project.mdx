...
<img src="/img/tutorial/gradle-panel.png" alt="Gradle Panel Example" width="500" />
...
<img src="/img/tutorial/paddles.png" alt="Two white paddles being created" width="550" />
...
<img src="/img/tutorial/red-ball.png" alt="A red ball appearing near the middle" width="550" />
...
<img src="/img/tutorial/ball-collision.gif" alt="A red ball bouncing between the two paddles" width="550" />
...
numbers at the bottom using **`FlixelText`**, the framework's text widget.
...
Download the <a href="/fonts/vcr.ttf" download="vcr.ttf"><u>**VCR OSD Mono** font</u></a>, a chunky retro monospace
...
<img src="/img/tutorial/white-zeros.png" alt="Two white zeros appearing on the bottom" width="550" />

---

We have the text objects added to the state, but right now they're static: they don't
...
Let's wire up a **pause screen** as a `FlixelSubState`. Press
**SPACE** to toggle pause; while paused, the gameplay freezes and a big
"PAUSED" label appears over the top.

:::tip[Remember the commercial break analogy?]

That is exactly what a substate is. The current state stays mounted *behind*
...
<img src="/img/tutorial/pause.gif" alt="The pause substate in action" width="550" />
...
<img src="/img/tutorial/game-over.gif" alt="The game over screen appearing" width="550" />

<p style={{ fontSize: '40px' }}><b>Congratulations, you just made your first game with FlixelGDX! 🎉</b></p>
