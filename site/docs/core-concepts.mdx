...
title: Core Concepts
sidebar_position: 3
description: The 6 essential building blocks every FlixelGDX game is built on.
---
...
This page walks through the 6 essential classes and systems that form the foundation of every FlixelGDX game.
